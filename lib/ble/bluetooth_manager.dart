        ...
        child: Column(
          children: <Widget>[
            ...
            StreamBuilder<List<BluetoothService>>(
              ...
              builder: (c, snapshot) {
                return ListTile(
                  title: const Text('Enable Light Sensor'),
                  trailing: IconButton(
                      icon: const Icon(Icons.send),
                      onPressed: () {
                        widget.device.discoverServices();
            ...
            StreamBuilder<List<BluetoothService>>(
              ...
              builder: (c, snapshot) {
                return ListTile(
                  title: const Text('Disable Light Sensor'),
                  trailing: IconButton(
                      icon: const Icon(Icons.send),
                      onPressed: () {
                        widget.device.discoverServices();
                ...
                return Align(
                    ...
                    child: Column(children: [
                      ...
                      Slider(
                        ...
                        onChanged: (value) {
                          widget.device.discoverServices();
                          var toWrite = 'manualdim~red~'+ value.toInt().toString();
                          writeData(snapshot.data!, toWrite);
